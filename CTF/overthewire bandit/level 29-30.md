...
Dice que no hay una contraseña n producción, intento hacer un git show, pero no hay nada en contraseñas

![](../../images/Pasted%20image%2020260408212904.png)


Entonces decido irme a otras ramas para saber si no subieron la contraseña en una rama colateral
usando el comando `git branch -a` (para ver todas las ramas)

![](../../images/Pasted%20image%2020260408213047.png)
