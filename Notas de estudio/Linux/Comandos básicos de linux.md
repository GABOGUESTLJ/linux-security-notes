- `PWD`= muestra donde está localizado el usuario 
	![[Pasted image 20260316133823.png]]
- `ls` = muestra los archivos![[Pasted image 20260316134016.png]]
- `cd` = cambia de directorio
	- `cd ..` = Sale de la carpeta actual a la anterior![[Pasted image 20260316134047.png]]
- `mkdir` = crea directorios
		Para crear ficheros que no existan dentro de otros fiecheros se usaa el -p antes del definir la ruta![[Pasted image 20260321105358.png]]
...
- `rm` = Elimina archivos
	- Ejemplo= `rm prac.txt`![[Pasted image 20260316134823.png|639]]
	- Para eliminar ficheros se usa el -r
	- ![[Pasted image 20260321105503.png]]
...
- Rutas absolutas y relativas
	...
	- Para crear carpetas con un espacio en el nombre se deben usar las comillas dobles![[Pasted image 20260316141845.png]]
	...
	- mv: este comando sirve para mover archivos a otros directorios, por ejemplo:![[Pasted image 20260321110612.png]]
	...
	- ![[Pasted image 20260327201519.png]]
	- y para decodificar un archivo se usa el parámetro -d
	- ![[Pasted image 20260327201623.png]]
...
![[Pasted image 20260405141429.png]]
